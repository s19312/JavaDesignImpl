...
//        car1.setCarDocuments(d1);// Rise an Exception.
        ...
        CarDocuments d7 = new CarDocuments(2250,LocalDateTime.now(),"r88432498",car2,owner3);//Rise an Exception
        CarDocuments d8 = new CarDocuments(2250,LocalDateTime.now(),"r88432498",car2,owner3);//Rise an Exception
